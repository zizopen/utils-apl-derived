...
public class TableUnmarshallerPlainTextTest
{
  ...
  private static void assertTable( Table<String> table, TableConfiguration tableConfiguration )
  {
    ...
    Assert.assertEquals( Arrays.asList( "0:0", "0:1" ), table.getRow( 0 ).asListOfCellElements() );
    Assert.assertEquals( Arrays.asList( "1:0", "1:1" ), table.getRow( 1 ).asListOfCellElements() );
    Assert.assertEquals( Arrays.asList( "2:0", "2:1" ), table.getRow( 2 ).asListOfCellElements() );
  }
