 ...
 * @author Omnaest
 */
public interface Table<E> extends Iterable<Table.Row<E>>, Serializable
{
   ...
   * 
   * @see IndexArrayTable#innerJoinByEqualColumn(IndexArrayTable, List)
   * @param joinTable
   ...
   * @param joinTable
   * @param currentTableColumnIndexPosition
   * @param joinTableColumnIndexPosition
   * @return
   */
   ...
   */
  public boolean equals( Table<E> indexedTable );
   ...
   * 
   * @author Omnaest
   * @see Table#convert(TableCellConverter)
   */
   ...
   * 
   * @author Omnaest
   * @see Table#processTableCells(TableCellVisitor)
   */
  ...
  public interface Row<E> extends List<E>, Serializable
  {
     ...
     * 
     * @see Table#getRowAsBean(Object, int)
     * @param beanObject
     * @return beanObject
     */
