 ...
 * @author Omnaest
 */
public class ElementConverterAlphaNumericEncodedStringToDecodedString implements ElementConverterSerializable<String, String>
{
  private static final long serialVersionUID = 38318980495631384L;
