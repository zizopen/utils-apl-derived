...
/**
 * Simple decorator for a {@link CharacterSequenceTokenizer}
 * 
 * @author Omnaest
 */
public class CharacterSequenceTokenizerDecorator implements CharacterSequenceTokenizer
{
  ...
  /**
   * @see CharacterSequenceTokenizerDecorator
  ...
  {
    return this.characterSequenceTokenizer != null ? this.characterSequenceTokenizer.iterator() : null;
  }
