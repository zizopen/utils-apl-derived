...
/**
 * {@link ExceptionHandler} which delegates to another instance
 * 
 * @author Omnaest
 */
public class ExceptionHandlerDelegate implements ExceptionHandlerSerializable
{
  /* ************************************************** Constants *************************************************** */
  private static final long         serialVersionUID = 3357366018938978957L;
  /* ***************************** Beans / Services / References / Delegates (external) ***************************** */
  private volatile ExceptionHandler exceptionHandler = null;
