...
/**
 * Adapter for {@link BigInteger} type
 * 
 * @see Adapter
 * @author Omnaest
 */
public class AdapterForBigIntegerType implements AdapterInternal
{
  ...
  public Set<Handler> newHandlerSet( final TransitiveBeanReplicationInvocationHandler transitiveBeanReplicationInvocationHandler )
  {
    return SetUtils.<Handler> valueOf( new Handler()
    {
      ...
      {
        return ( (BigInteger) sourceObject ).add( BigInteger.ZERO );
      }
      
      @Override
      public boolean canHandle( Class<? extends Object> sourceObjectType )
      {
        return sourceObjectType != null && BigInteger.class.equals( sourceObjectType );
      }
      ...
      public String toString()
      {
        ...
        builder.append( "Handler of AdapterForBigIntegerType" );
  ...
  {
    StringBuilder builder = new StringBuilder();
    builder.append( "AdapterForBigIntegerType" );
    return builder.toString();
  }
}
