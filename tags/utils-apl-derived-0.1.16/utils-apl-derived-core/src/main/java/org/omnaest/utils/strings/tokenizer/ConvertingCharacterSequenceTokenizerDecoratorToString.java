...
/**
 * {@link ConvertingCharacterSequenceTokenizerDecorator} which outputs a {@link String}
 * 
 * @author Omnaest
 */
...
{
  /**
   * @see ConvertingCharacterSequenceTokenizerDecoratorToString
  ...
  {
    super( characterSequenceTokenizer, new ElementConverterGenericElementToString<CharSequence>() );
  }
